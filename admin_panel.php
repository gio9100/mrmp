...
button:hover { background: #00ffe0; color: #000; }
button.eliminar { background: #ff4444; }
button.eliminar:hover { background: #ff6666; }
table { 
    width: 100%; 
...
<!-- Panel Admin -->
<header>
<h1>Panel de Administración MRMC</h1>
<a href="?logout" style="color:#ffd700;">Cerrar sesión</a>
</header>
...
&copy; <?= date('Y') ?> Mexican Motor Company
</footer>
